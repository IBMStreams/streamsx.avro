 ...
 */
@PrimitiveOperator(name = "AvroFileSource", namespace = "com.ibm.streamsx.avro.test", description = "Reads an Avro file with embedded schema and submits a BLOB tupple", comment = AvroFileSource.IBM_COPYRIGHT)
@OutputPorts({
...
public class AvroFileSource extends ProcessTupleProducer {
	...
	protected void process() throws Exception {
		...
		File avroFile = new File("data/twitter.avro");
		FileInputStream fis = null;
		byte[] bFile = new byte[(int) avroFile.length()];
		...
		Blob blobData = ValueFactory.newBlob(bFile);
